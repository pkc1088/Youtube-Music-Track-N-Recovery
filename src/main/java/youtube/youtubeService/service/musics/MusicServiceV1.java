...
//    private static YouTube youtube;
    ...
    public MusicServiceV1(PlaylistRepository playlistRepository, MusicRepository musicRepository, YoutubeApiClient youtubeApiClient) {
...
//    }
    ...
    public void initiallyAddVideoDetails(String playlistId) throws IOException {
        List<PlaylistItem> response = youtubeApiClient.getPlaylistItemListResponse(playlistId, 50L); // 여긴 굳이 예외 처리 안 해도 됨
