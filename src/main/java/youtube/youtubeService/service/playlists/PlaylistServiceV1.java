...
public class PlaylistServiceV1 implements PlaylistService {
    ...
    public PlaylistRegistrationResultDto registerPlaylists(PlaylistRegisterRequestDto request) {
        ...
        PlaylistRegistrationResultDto playlistRegistrationResultDto = null;
        ...
        if (!newlySelectedPlaylists.isEmpty()) {
            playlistRegistrationResultDto = registerSelectedPlaylists(user, newlySelectedPlaylists);  // 중복되지 않는 플레이리스트만 등록
        }
        ...
        return playlistRegistrationResultDto;
    }

    private PlaylistRegistrationResultDto registerSelectedPlaylists(Users user, List<PlaylistDto> selectedPlaylistsDto) {
    ...
    public Map<String, List<String>> updatePlaylist(String userId, String countryCode, Playlists playlist, List<MusicSummaryDto> pureDbMusicList) throws IOException {
        ...
        try {
            ...
            removePlaylistsFromDB(Collections.singletonList(playlistId));
